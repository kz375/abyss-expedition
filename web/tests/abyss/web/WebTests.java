...
public final class WebTests {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (WebServer server = new WebServer(new InetSocketAddress("127.0.0.1", 0),
            ...
            check(betaPage.contains("1.9.1-art-fx-lab"), "beta page uses one cache-busted release");
            ...
            check(call("/art-test/style.css?v=0.1.0", null).headers().firstValue("Content-Type").orElse("").contains("text/css"), "art lab stylesheet MIME type");
            check(call("/art-test/lab.js?v=0.1.0", null).headers().firstValue("Content-Type").orElse("").contains("javascript"), "art lab script MIME type");
