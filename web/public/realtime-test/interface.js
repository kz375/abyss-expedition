...
function init(){
  ...
  $("language").onclick=()=>{profile.locale=profile.locale==="en"?"zh":"en";writeProfile();renderScene();if(archiveKind)renderArchive();};$("codex").onclick=()=>openArchive("codex");$("achievements").onclick=()=>openArchive("achievements");$("potion").onclick=usePotion;
