...
const EVENT_PRESENTATION={
  ...
  shrine:{icon:"◇",tone:"arcane",desc:["无名神像俯视着你。石座上的旧血仍未完全干涸。","A nameless figure watches from the stone. The old blood on its altar has not yet dried."]},
  chest:{icon:"▣",tone:"risk",desc:["锁舌里传来细小抓挠声。里面也许是财富，也许不是。","Something scratches softly behind the lock. It may be treasure. It may not."]},
  healer:{icon:"✚",tone:"safe",desc:["医师没有问你的名字，只用指尖敲了敲空药瓶。","The healer asks no name, only taps a finger against an empty bottle."]},
  spring:{icon:"≈",tone:"arcane",desc:["银色泉水倒映出一张并不属于你的脸。","The silver water reflects a face that is not yours."]},
  adventurer:{icon:"⚑",tone:"risk",desc:["求救声从坍塌的石柱后传来，远处也响起了脚步。","A cry comes from behind the collapsed pillars. Footsteps answer in the distance."]},
  gambler:{icon:"⚄",tone:"trade",desc:["骨骰在杯中作响。赌徒笑着为你留出一个位置。","Bone dice rattle in a cup. The gambler smiles and makes room for you."]},
  library:{icon:"▤",tone:"arcane",desc:["书页自行翻动，墨迹像虫群一样重新排列。","Pages turn by themselves, their ink rearranging like a swarm."]},
  well:{icon:"◉",tone:"arcane",desc:["井底有人用你的声音许诺力量。","Something at the bottom promises power in your own voice."]},
  cards:{icon:"♠",tone:"risk",desc:["三张牌面朝下。骗子的袖口比他的笑容更可疑。","Three cards lie face down. The sharp's sleeves are less honest than his smile."]},
  oracle:{icon:"☽",tone:"arcane",desc:["预言家闭着眼，却准确地望向你下一步会站的位置。","The oracle's eyes are closed, yet she watches the place where you will stand next."]},
  curator:{icon:"✦",tone:"trade",desc:["玻璃柜中，每件遗物都在轻轻呼吸。","Inside the glass cases, every relic seems to breathe."]},
  rift:{icon:"⌁",tone:"risk",desc:["裂隙另一侧传来磨刀声。门已经为你打开。","A blade is being sharpened beyond the rift. The way is already open."]},
  forge:{icon:"⚒",tone:"risk",desc:["熔炉需要的不是煤。铁砧正在等待你的代价。","This forge does not burn coal. The anvil waits for your price."]},
  altar:{icon:"△",tone:"arcane",desc:["你的脚步在祭坛上重复了三次，最后一次不是回声。","Your footstep repeats three times across the altar. The last is not an echo."]},
  caravan:{icon:"✧",tone:"trade",desc:["月光商队从不回头，也从不为同一个人停留两次。","The moonlit caravan never turns back, and never stops twice for the same traveler."]},
  idol:{icon:"♜",tone:"risk",desc:["神像张着空洞的嘴。它闻到了活人的温度。","The idol's hollow mouth hangs open. It has tasted the warmth of the living."]},
  stalker:{icon:"◌",tone:"trial",desc:["那道身影总与你隔着七步。它在等你跟上。","The silhouette remains seven steps ahead. It is waiting for you to follow."]},
  trial:{icon:"⬡",tone:"trial",desc:["两枚核心在石盘深处共鸣。四十步之内，只有一次答案。","Twin cores resonate beneath the stone board. Within forty moves, there is only one answer."]}
};
const SHOP=[
